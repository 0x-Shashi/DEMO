          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 border-t">
              ...
              <div className="flex flex-wrap gap-2">
                <Badge variant="info">Manage Users</Badge>
                <Badge variant="info">Manage Departments</Badge>
                <Badge variant="info">Manage Timetables</Badge>
                <Badge variant="info">System Settings</Badge>
                <Badge variant="info">View Reports</Badge>
              </div>
            </div>
          </CardContent>
        </Card>
